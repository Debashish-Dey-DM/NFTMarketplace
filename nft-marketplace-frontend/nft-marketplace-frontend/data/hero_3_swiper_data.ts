...
interface iHero_3_swiper_thumbs_data{
    id: string;
    image: string;
}

const hero_3_swiper_data: iHero_3_swiper_data[] = [
	{
...
const hero_3_swiper_thumbs_data: iHero_3_swiper_thumbs_data[] = [
	{
