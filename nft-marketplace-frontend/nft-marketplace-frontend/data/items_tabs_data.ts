...
interface iItems_Properties_data{
    id: number;
    category: string;
    product: string;
    trait: string;
...
interface iItems_activity_data {
    id: string;
    price: string;
    from: string;
    to: string;
...
const items_offer_data: iItems_offer_data[] = [
	{
		id: '1ViviGiallo',
		ethPrice: '30',
		usdPrice: '$90,136.10',
...
const items_Properties_data: iItems_Properties_data[] = [
	{
		id: 0,
		category: 'ACCESSORY',
...
const items_activity_data: iItems_activity_data[] = [
	{
		id: '1ViviGiallo',
		price: '30',
		from: 'AD496A',
