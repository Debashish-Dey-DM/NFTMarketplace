						...
						<div className="mx-auto max-w-[53.125rem]">
							...
							<div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 dark:divide-jacarta-600 divide-jacarta-100 mb-14 divide-y overflow-hidden rounded-lg border bg-white">
								<div className="flex items-center justify-between py-4 px-5">
									<span className="text-jacarta-700 font-medium dark:text-white">API</span>
								...
								<div className="flex items-center justify-between py-4 px-5">
									<span className="text-jacarta-700 font-medium dark:text-white">Website</span>
									<span className="text-green">Operational</span>
								</div>
								<div className="flex items-center justify-between py-4 px-5">
									<span className="text-jacarta-700 font-medium dark:text-white">
								...
								<div className="flex items-center justify-between py-4 px-5">
									<span className="text-jacarta-700 font-medium dark:text-white">Emails</span>
									<span className="text-green">Operational</span>
								</div>
							</div>
							...
							<div className="mb-8">
								...
								<div className="mb-6">
									...
									<time className="dark:text-jacarta-300 text-sm">Apr 5, 16:53 UTC</time>
								</div>
								<div className="mb-6">
									<p className="dark:text-jacarta-300">
									...
									<time className="dark:text-jacarta-300 text-sm">Apr 5, 16:52 UTC</time>
								</div>
								<div className="mb-6">
									<p className="dark:text-jacarta-300">
									...
									<time className="dark:text-jacarta-300 text-sm">Apr 5, 16:45 UTC</time>
								</div>
							</div>
